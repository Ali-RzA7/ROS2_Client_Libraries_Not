...
from tut_interface.msg import Num
class MekatekPublisher(Node):

    def __init__(self):
        super().__init__('mekatek_publisher') # Düğüm oluşturulur
        self.publisher_ = self.create_publisher(Num, 'mekatek_topic', 10)# Publisher oluşturulur.String mesaj türü, mekatek_topic topic ismi, kuyruk boyutu. self.publisher_ MekatekPublisher sınıfının bir üyesi olan bir yayıncı nesnesidir.
