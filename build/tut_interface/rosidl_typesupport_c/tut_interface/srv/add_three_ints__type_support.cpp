...
#include "tut_interface/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _AddThreeInts_Request_type_support_symbol_names_t _AddThreeInts_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tut_interface, srv, AddThreeInts_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tut_interface, srv, AddThreeInts_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_tut_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tut_interface, srv, AddThreeInts_Request)() {
  return &::tut_interface::srv::rosidl_typesupport_c::AddThreeInts_Request_message_type_support_handle;
}
...
static const _AddThreeInts_Response_type_support_symbol_names_t _AddThreeInts_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tut_interface, srv, AddThreeInts_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tut_interface, srv, AddThreeInts_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_tut_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tut_interface, srv, AddThreeInts_Response)() {
  return &::tut_interface::srv::rosidl_typesupport_c::AddThreeInts_Response_message_type_support_handle;
}
...
static const _AddThreeInts_type_support_symbol_names_t _AddThreeInts_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tut_interface, srv, AddThreeInts)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tut_interface, srv, AddThreeInts)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, tut_interface, srv, AddThreeInts)() {
  return &::tut_interface::srv::rosidl_typesupport_c::AddThreeInts_service_type_support_handle;
}
