...
#include "tut_interface/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const tut_interface::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tut_interface::msg::Num *>(
    untyped_ros_message);
...
{
  return &tut_interface::msg::typesupport_fastrtps_cpp::_Num__handle;
}
