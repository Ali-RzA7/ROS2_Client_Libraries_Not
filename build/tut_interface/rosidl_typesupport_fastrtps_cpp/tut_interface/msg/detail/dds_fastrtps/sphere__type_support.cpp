...
#include "tut_interface/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tut_interface::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tut_interface::msg::Sphere & ros_message)
{
  // Member: center
...
{
  auto typed_message =
    static_cast<const tut_interface::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tut_interface::msg::Sphere *>(
    untyped_ros_message);
...
{
  return &tut_interface::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tut_interface, msg, Sphere)() {
  return &tut_interface::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
