...
#include <stddef.h>
#include "tut_interface/msg/detail/sphere__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  tut_interface__msg__Sphere__init(message_memory);
}

void Sphere__rosidl_typesupport_introspection_c__Sphere_fini_function(void * message_memory)
{
  tut_interface__msg__Sphere__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Sphere__rosidl_typesupport_introspection_c__Sphere_message_member_array[2] = {
  {
    ...
    offsetof(tut_interface__msg__Sphere, center),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tut_interface__msg__Sphere, radius),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Sphere__rosidl_typesupport_introspection_c__Sphere_message_members = {
  "tut_interface__msg",  // message namespace
  "Sphere",  // message name
  2,  // number of fields
  sizeof(tut_interface__msg__Sphere),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tut_interface, msg, Sphere)() {
